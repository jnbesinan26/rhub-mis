...
/**
 * This is the model class for table "mis_external_environments".
 *
 * The followings are the available columns in table 'mis_external_environments':
...
class ExternalEnvironments extends CActiveRecord
{
	...
	{
		return 'mis_external_environments';
	}
